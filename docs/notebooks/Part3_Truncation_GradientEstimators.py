...
# + executionInfo={"elapsed": 57, "status": "ok", "timestamp": 1643170875395, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="5QM56Si43pS7" outputId="0ea08631-fafb-4478-91bd-739d1e47ecdd"
...
# + executionInfo={"elapsed": 9594, "status": "ok", "timestamp": 1643170885144, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="PQFGy7Ib9q7f"
key = jax.random.PRNGKey(0)
...
# + [markdown] id="GcolDnWEAkOV"
# Now we can plot the losses. We see a sequence of decreasing losses, which get reset back to initialization every 25 steps.

# + colab={"height": 296} executionInfo={"elapsed": 265, "status": "ok", "timestamp": 1643170885557, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="eGD7UTfMASBl" outputId="9f278e50-e84e-4911-9ecc-7b63959f251f"
plt.plot(losses)
plt.xlabel("all inner-iteration")
plt.ylabel("loss")

# + [markdown] id="uLXf29yTA3XE"
...
# + executionInfo={"elapsed": 4518, "status": "ok", "timestamp": 1643170890300, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="nEbvhc1-BnRH"
n_tasks = 8
...
# + colab={"height": 296} executionInfo={"elapsed": 220, "status": "ok", "timestamp": 1643170890664, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="Sm7i1JkPC0T5" outputId="0dc0d7e0-6957-40b2-8c33-67c13d757fb0"
...
# + executionInfo={"elapsed": 1752, "status": "ok", "timestamp": 1643170892634, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="TK_7qVf0DaDT"
key = jax.random.PRNGKey(0)
keys = jax.random.split(key, n_tasks)
states = jax.vmap(init_state)(keys)
...
# + colab={"height": 265} executionInfo={"elapsed": 218, "status": "ok", "timestamp": 1643170893008, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="8avrxbDDEQs_" outputId="c69a107f-c5ea-4f0b-8fde-99643b6dfcb2"
losses = np.asarray(losses)
for i in range(n_tasks):
  plt.plot(losses[:, i])

# + [markdown] id="FWjUQFwjEXgY"
...
# + executionInfo={"elapsed": 81, "status": "ok", "timestamp": 1643170893389, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="9UI2k2uAhVUP"
...
# + executionInfo={"elapsed": 5, "status": "ok", "timestamp": 1643170893745, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="W5vQVk7o_VDq"
...
# + executionInfo={"elapsed": 58, "status": "ok", "timestamp": 1643170894042, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="nLOAKLXX_nX4"
key = jax.random.PRNGKey(0)
theta = lopt.init(key)
...
# + executionInfo={"elapsed": 5, "status": "ok", "timestamp": 1643170894200, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="zyaPyPLY_nX5" outputId="7c3a6473-2c04-48ce-a0b2-4da5f2c3c58d"
...
# + executionInfo={"elapsed": 3449, "status": "ok", "timestamp": 1643170897825, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="rbSr9tFc_vth"
...
# + executionInfo={"elapsed": 4, "status": "ok", "timestamp": 1643170898016, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="XuoeYAt9_1hL" outputId="7a9df483-f98d-4af7-b8b1-68b5a2ec34ed"
out.grad
...
# + executionInfo={"elapsed": 58, "status": "ok", "timestamp": 1643170898252, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="ailS8_Jbr8CT"
task_family = quadratics.FixedDimQuadraticFamily(10)
lopt = lopt_base.LearnableAdam()
max_length = 1000
...
# + executionInfo={"elapsed": 58, "status": "ok", "timestamp": 1643170898454, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="Nx1BTPIG4gEJ"
key = jax.random.PRNGKey(0)
theta = lopt.init(key)
worker_weights = gradient_learner.WorkerWeights(
    theta=theta,
...
# + executionInfo={"elapsed": 1140, "status": "ok", "timestamp": 1643170899742, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="NlCnF8LT4HBx" outputId="4dfc512b-cce4-463f-f6b4-b9939f5a0b26"
gradient_estimator_state = gradient_estimator.init_worker_state(
    worker_weights, key=key)
...
# + executionInfo={"elapsed": 55, "status": "ok", "timestamp": 1643170899948, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="u1QQxUYf31fy" outputId="549c6209-6c2e-4219-d6ff-9d333c4ec313"
...
# + executionInfo={"elapsed": 4715, "status": "ok", "timestamp": 1643170904965, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="MSpQTFc45lz2" outputId="57caf27d-8317-4c8b-e93a-47b5320ac3cc"
out, metrics = gradient_estimator.compute_gradient_estimate(
    worker_weights, key=key, state=gradient_estimator_state, with_summary=False)
...
# + executionInfo={"elapsed": 5, "status": "ok", "timestamp": 1643170905123, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="74AnlkqB4xCV" outputId="433091f9-6842-436f-9ac6-eb6a40438584"
out.grad

# + executionInfo={"elapsed": 63, "status": "ok", "timestamp": 1643170905365, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="82oSxk2i5-3L" outputId="95ba9386-fac5-4295-972c-cc514da1572d"
...
# + executionInfo={"elapsed": 63, "status": "ok", "timestamp": 1643170905582, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="VTPgbwtj6X0I" outputId="df510426-8627-4462-dbd8-ba7a27d3882f"

...
# + executionInfo={"elapsed": 5659, "status": "ok", "timestamp": 1643173202623, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="49b53916" outputId="fb69ee9e-cf0c-4e7f-d601-b9dea16f473f"
...
# + executionInfo={"elapsed": 318, "status": "ok", "timestamp": 1643173203307, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="d5033451" outputId="f95171bb-5087-4ed1-8ddd-a9a42ff89e88"
key, key1 = jax.random.split(key)

loss = task.loss(params, key1, batch)
loss

# + [markdown] id="72c0828a"
...
# + executionInfo={"elapsed": 960, "status": "ok", "timestamp": 1643173205253, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="49cbc7ba" outputId="cc472f4d-2695-4bc0-df78-6178eea5b0eb"
...
# + executionInfo={"elapsed": 5, "status": "ok", "timestamp": 1643173205421, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="e9673b31" outputId="848b36a3-3bb4-421d-b558-170e0730a18b"
...
# + [markdown] id="9cf3fb23"
# We can see the `opt_state` has parameter values, and a couple other values such as current iteration.

# + executionInfo={"elapsed": 75, "status": "ok", "timestamp": 1643173205656, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="5db1e09c" outputId="4eab9598-17a9-4ae0-a3ea-04639ab0dcd7"
opt = opt_base.Adam(1e-4)
opt_state = opt.init(fake_params)
opt_state

# + [markdown] id="337afafe"
...
# + executionInfo={"elapsed": 68, "status": "ok", "timestamp": 1643173205854, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="357962b9" outputId="de9a3d77-11d5-48b9-f293-bed832537cee"
...
# + executionInfo={"elapsed": 543, "status": "ok", "timestamp": 1643173206548, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="52fa2b0d" outputId="afb7c02f-0baf-4ec6-9847-f65d8ae90ba2"
task = image_mlp.ImageMLP_FashionMnist8_Relu32()
key = jax.random.PRNGKey(0)
params = task.init(key)
...
# + executionInfo={"elapsed": 692, "status": "ok", "timestamp": 1643173207374, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="a2ebdbd5" outputId="a141a7c1-baa9-47b4-eb35-e3e45a8c7493"
task = image_mlp.ImageMLP_FashionMnist8_Relu32()
key = jax.random.PRNGKey(0)
params = task.init(key)
...
# + executionInfo={"elapsed": 167, "status": "ok", "timestamp": 1643173207718, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="65a556ce" outputId="966a8921-c6d8-448e-9f0a-fcd9c5f75cc6"
import flax
...
# + executionInfo={"elapsed": 60, "status": "ok", "timestamp": 1643173207903, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="d7a8bd53" outputId="62d867f0-2095-415e-cb03-a1bea9951794"
lopt = lopt_base.LearnableAdam()
theta = lopt.init(key)
theta

# + [markdown] id="22c5ac36"
...
# + executionInfo={"elapsed": 416, "status": "ok", "timestamp": 1643173208653, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="d83689fc" outputId="454b36b2-97b2-4615-fce9-b2c58ff254b5"
task = image_mlp.ImageMLP_FashionMnist8_Relu32()
key = jax.random.PRNGKey(0)
...
# + executionInfo={"elapsed": 14706, "status": "ok", "timestamp": 1643173223561, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="bcffb853" outputId="26b32b58-50f6-42ff-abc0-04ff33c103cc"
meta_value_and_grad = jax.jit(jax.value_and_grad(meta_loss))

ml, meta_grad = meta_value_and_grad(theta, key, batch)
meta_grad

# + [markdown] id="683ab7ab"
...
# + executionInfo={"elapsed": 17330, "status": "ok", "timestamp": 1643173241067, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="2df4120e" outputId="6c5663d7-647e-4fc7-cae2-d75dd5ba8280"
...
# + colab={"height": 296} executionInfo={"elapsed": 934, "status": "ok", "timestamp": 1643173242450, "user": {"displayName": "", "photoUrl": "", "userId": ""}, "user_tz": 480} id="a7456b62" outputId="57cac3cc-cc6e-4dbc-f717-22ebaad14428"
import numpy as np
from matplotlib import pylab as plt
